...
public class Solution309 {
    ...
    public int maxProfit(int[] prices) {
        count=0;
        findMaxProfit(prices, 0, -1, 0);
        return count;
    }

    private void findMaxProfit(int[] prices, int fee, int stockHold, int money) {
        if(prices.length==0){
            if(money>count){
                count=money;
            }
        ...
        if(stockHold==-1){
            ...
            findMaxProfit(newPrices, fee, stockHold, money);
            ...
            if(prices[0]>(stockHold+fee)){ // 可以卖
                ...
                if(newPrices.length<1){
                    ...
                    prices = new int[newPrices.length-1];
                    System.arraycopy(newPrices,1,prices,0,prices.length);
                }
                findMaxProfit(prices, fee, stockHold, money);
            }
