...
//    private static HashSet<Integer> DELICIOUS = new HashSet<>();
//
//    public int countPairs(int[] deliciousness) {
//        HashMap<Integer, Integer> combines = new HashMap<>();
...
//                String note1 = k + " " + j;
//                String note2 = j + " " + k;
//                if (set.contains(note1) || set.contains(note2)) {
//                    continue;
//                } else {
//                    set.add(note1);
//                    set.add(note2);
...
//                if (k == j) {
//                    key = k * 2;
//                    value = record.get(k) * (record.get(k) - 1) / 2;
//                } else {
//                    key = k + j;
//                    value = record.get(k) * record.get(j);
//                }
//                max = Math.max(key, max);
//                if (combines.containsKey(key)) {
//                    combines.put(key, combines.get(key) + value);
//                } else {
//                    combines.put(key, value);
//                }
//            }
//        }
//        init(max);
//        int result = 0;
//        for (Integer key : combines.keySet()) {
//            if (isDelicious(key)) {
//                result += combines.get(key);
//            }
//        }
...
//    private boolean isDelicious(int key) {
////        double value = Math.log(key) / Math.log(2);
////        return value - Math.floor(value) < 10e-7;
//        return DELICIOUS.contains(key);
//    }
